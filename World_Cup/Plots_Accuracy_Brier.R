...
ggsave(filename = "acc_plot_WC_MAD.pdf",path = "Plots", plot = acc_plot,
...
ggsave(filename = "brier_plot_WC_MAD.pdf",path = "Plots", plot = brier_plot,
       width = 15, height = 10, device='pdf', dpi=500, useDingbats = FALSE)
