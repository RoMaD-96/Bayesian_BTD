...
colnames(fifa_ranking_clean) <- c("team_name", "ranking")#fifa_ranking_clean$ranking <- fifa_ranking_clean$ranking/10^3
...
print("Doing Poisson Models WC with FIFA Rank")
...
save(diag_inf_biv_pois_GS, biv_pois_GS, double_pois_GS, file = "World_Cup/Fifa_Ranking/RData/Stat_Model_GS.RData")
...
save(diag_inf_biv_pois_KS, biv_pois_KS, double_pois_KS, file = "World_Cup/Fifa_Ranking/RData/Stat_Model_KS.RData")
