...
print("Computing Brier Score and Accuracy Group Stage FIFA")
...
load("World_Cup/Fifa_Ranking/RData/Stat_Model_GS.RData")
...
print("Computing Brier Score and Accuracy Knockout Stage FIFA")
...
load("World_Cup/Fifa_Ranking/RData/Stat_Model_KS.RData")
...
save(
  ...
  brier_groupstage_GS,
  brier_groupstage_KS,
  file = "World_Cup/Fifa_Ranking/RData/Brier_GS_KS.RData"
)
...
save(
  ...
  acc_groupstage_GS,
  acc_groupstage_KS,
  file = "World_Cup/Fifa_Ranking/RData/Accuracy_GS_KS.RData"
)
