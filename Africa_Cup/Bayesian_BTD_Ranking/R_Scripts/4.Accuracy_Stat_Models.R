...
print("Doing Accuracy e Brier Score Poisson Models with BT rank")
...
load("Africa_Cup/Bayesian_BTD_Ranking/RData/Stat_Model_GS.RData")
...
load("Africa_Cup/Bayesian_BTD_Ranking/RData/Stat_Model_KS.RData")
...
save(
  ...
  brier_groupstage_GS,
  brier_groupstage_KS,
  file = "Africa_Cup/Bayesian_BTD_Ranking/RData/Brier_GS_KS.RData"
)
...
save(
  ...
  acc_groupstage_GS,
  acc_groupstage_KS,
  file = "Africa_Cup/Bayesian_BTD_Ranking/RData/Accuracy_GS_KS.RData"
)
