...
save(diag_inf_biv_pois_GS, biv_pois_GS, double_pois_GS, file = "Africa_Cup/Bayesian_BTD_Ranking/RData/Stat_Model_GS.RData")
...
save(diag_inf_biv_pois_KS, biv_pois_KS, double_pois_KS, file = "Africa_Cup/Bayesian_BTD_Ranking/RData/Stat_Model_KS.RData")
